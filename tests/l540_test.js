...
const iFetch=AUTH.indexOf('_l540Read=await _l537FetchRefs('), iProf=AUTH.indexOf('if(profile){'), iKeep=AUTH.indexOf('}else if(!(_l540Read&&Object.keys(USER_PROFILES).length)){'), iOut=AUTH.indexOf('firebase.auth().signOut()');
