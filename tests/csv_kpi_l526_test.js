...
if(HDR&&ROW){
  ...
  ok(HDR.join(';').indexOf('m² coupés (bobines mères);Perte % (m²);Perte m²;Déchet m²;Déchet %;Chutes gardées m²')>=0,'bloc matiere dans l ORDRE du CSV fiches : m² ; Perte % (m²) ; Perte m² ; Déchet m² ; Déchet % ; Chutes gardées m²');
  ...
  ok(col(r,'Déchet m²')==='78,5'&&col(r,'m² coupés (bobines mères)')==='4200'&&col(r,'Perte m²')==='193','virgule FR sur les decimaux, entiers intacts → '+col(r,'Déchet m²')+' / '+col(r,'m² coupés (bobines mères)')+' / '+col(r,'Perte m²'));
  ...
  ok(col(ro,'Perte % (m²)')==='n/d'&&col(ro,'Perte m²')==='n/d'&&col(ro,'m² coupés (bobines mères)')==='n/d'&&col(ro,'FEBA perte m²')==='n/d','m², Perte m², % et perte machine en n/d');
